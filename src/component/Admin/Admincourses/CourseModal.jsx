            ...
            <Box px={['0', '16']}>
              ...
              {lectures.map((item, i) => (
                <VideoCard
                  key={i}
                  title="React Intro"
                  description="This is intro lecture where you learn basic of react"
                  num={i + 1}
                  lectureId="vsgvdhdksddnjd"
                  courseId={id}
                  deleteButtonHandler={deleteLectureHadler}
                />
              ))}
            </Box>
            <Box>
              <form
                onSubmit={e =>
                  addLectureHanlder(e, id, title, description, video)
                }
              >
                <VStack spacing={'4'}>
                  <Heading
